package com.example.demo.card.security;
...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateToken(FDAIndiaKendra fdaIndiaKendra) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("sub", fdaIndiaKendra.getUsername());
        claims.put("aud", "Kendra");
    ...
    public String generateToken(FDAIndiaCard fdaIndiaCard) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("sub", fdaIndiaCard.getUsername());
        claims.put("aud", "User");
    ...
    public String generateTokenWithSessionId(FDAIndiaKendra fdaIndiaKendra, String sessionId, Date sessionExpiry) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("sub", fdaIndiaKendra.getUsername());
        claims.put("aud", "Kendra");
