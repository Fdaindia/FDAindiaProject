...
import com.example.demo.services.KendraKycService;
import com.example.demo.services.UserServices;

@RestController
@RequestMapping("/kendra/kyckendra")
public class KendraKycController {

	@Autowired
	private KendraKycService userService;
	...
	public UserResponse createUser(@RequestParam("name") String name, @RequestParam("dob") String dob,
		...
		userService.saveUser(user, adharCard, panCard, domicile, lpc, idProof);
	...
	public KendraKyc getUserByEmail(@PathVariable String email){
		KendraKyc kycuser=userService.getUserByEmail(email);
...
//	}
	...
	private String saveFile(MultipartFile file) throws IOException {
		FDAIndiaKendra fik = us.getUserByEmail(femail);
